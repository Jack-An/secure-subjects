	...
	<view class="u-search" @tap="clickHandler" :style="{
		...
		>
			...
			<view class="u-icon-wrap">
				...
				<image src="../../../static/seachar_icon.png" mode="" @click="search" 
				style="width: 36rpx; height:38rpx; margin-right: 10rpx;"></image>
			</view>
...
.u-content {
	...
	padding: 0 18rpx;
	flex: 1;
	box-shadow: 0px 0px 10rpx 1rpx rgba(0, 0, 0, 0.1);
}
